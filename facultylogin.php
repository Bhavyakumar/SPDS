     ...
     <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-2 col-sm-8 col-sm-offset-2">                    
        <div class="panel panel-info" >
           <div class="panel-heading">
              <div class="panel-title">Faculty Sign In</div>
           </div>     
                ...
                <div style="padding-top:30px" class="panel-body" >
                  <?php
                   ...
                   ?>         
                    <form action='facultylogin_suc.php' method='POST'>
                                    
                      <div style="margin-bottom: 25px" class="input-group">
                        <span class="input-group-addon">
                          <i class="glyphicon glyphicon-user"></i>
                        </span>
                        <input type="text" class="form-control" name="funame" id="funame" placeholder="username or email" required>
                      </div>
                      ...
                      <div style="margin-bottom: 25px" class="input-group"> 
                        ...
                        <input type="password" class="form-control" id="fpwd" name="fpwd" placeholder="password" required>
                      </div>
                      ...
                      <br>
                       <div class="form-group">
                           <div class="col-md-12 control">
                               <a href="facultyreg.php">Sign Up Here</a>
                           </div>
                       </div>
                    </form> 
                  </div>         
