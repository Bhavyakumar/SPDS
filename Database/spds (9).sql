...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2019 at 01:59 AM
...
(3, 4, 'Report Submission', '2019-11-29'),
...
(14, 6, 'Dr. J. V. Suthar', 'jvsuthar@aau.in', '9898785620', 'jvsuthar', 1, 'Minor'),
...
INSERT INTO `remark` (`r_id`, `reg_no`, `f_id`, `sy_remark`, `sub_id`, `status`, `re_remark`) VALUES
(1, '06-0202-2016', 14, 'Done gdfg', 7, 0, 'sdfsdf dfgffhfhgfhgfdhgfdhgfhgfhgfhgf'),
(5, '06-0218-2016', 16, 'Not Justify a content of synopsis.\r\n', 8, 0, 'gfdgdfgf'),
(23, '06-0202-2016', 9, 'almost done but not justify.\r\n', 7, 1, ''),
(24, '06-0218-2016', 9, 'Justify your content.', 8, 1, ''),
(25, '06-0210-2016', 14, 'Done.', 9, 0, 'dsgfsdgd');
...
('06-0218-2016', 4, 'Nigam Kavar', 18, 'patelnigam4599@student.aau.in', '9624021922', 'nigam@12'),
('06-0236-2016', 3, 'Keyur Markana', 5, 'keyurmarkna@student.aau.in', '7845796213', '123');
...
--
ALTER TABLE `activity`
  MODIFY `a_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;
...
--
ALTER TABLE `title`
  MODIFY `t_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
