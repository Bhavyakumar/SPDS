...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2019 at 01:47 AM
...
(7, 4, 'Dr. D. K. Parmar', 'dkparmar@aau.in', '8978456958', 'dkparmar', 0, NULL),
(8, 4, 'Dr. D. R. Kathiriya', 'deanait@aau.in', '9874562130', 'deanait', 0, NULL),
(9, 4, 'Dr. R. S. Parmar', 'rsparmar@aau.in', '9898785620', 'rsparmar', 0, NULL);
...
--
-- Indexes for table `guide_allocation`
--
ALTER TABLE `guide_allocation`
...
--
-- AUTO_INCREMENT for table `guide_allocation`
--
ALTER TABLE `guide_allocation`
...
--
-- Constraints for table `guide_allocation`
--
ALTER TABLE `guide_allocation`
  ADD CONSTRAINT `guide_allocation_ibfk_1` FOREIGN KEY (`reg_no`) REFERENCES `student` (`reg_no`),
  ADD CONSTRAINT `guide_allocation_ibfk_2` FOREIGN KEY (`f_id`) REFERENCES `faculty` (`f_id`);
