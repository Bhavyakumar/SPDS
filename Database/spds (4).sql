...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2019 at 02:07 AM
...
(10, 4, 'Dr. D. R. Kathiriya', 'deanait@aau.in', '9865451230', 'deanait', 0, 'Major'),
(13, 4, 'Dr. Mayur Raj', 'mpraj@aau.in', '8898564785', 'mpraj', 1, 'Major'),
(14, 4, 'Dr. J. V. Suthar', 'jvsuthar@aau.in', '9898785620', 'jvsuthar', 1, 'Minor'),
(16, 4, 'Prof. N. M. Vegad', 'nileshvegad@aau.in', '7878787878', 'nmvegad', 0, 'Minor');
...
('06-0200-2016', 3, 'Nilay Bhatt', 2, 'nilay12@gmail.com', '8789787452', '123'),
...
--
ALTER TABLE `major_guide`
  MODIFY `maj_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `minor_guide`
--
ALTER TABLE `minor_guide`
  MODIFY `minor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
