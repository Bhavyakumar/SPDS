...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2019 at 02:06 AM
...
(5, 'Report Submission', '2019-11-28'),
(6, 'Project Presentation', '2019-12-05');
...
('06-0200-2016', 4, 'Nilay Bhatt', 2, 'nilay12@gmail.com', '8789787452', '123'),
...
('06-0218-2016', 4, 'Nigam Patel', 18, 'nigam@gmail.com', '9624021922', '123');
...
(24, '06-0218-2016', 'KrishiChat', 'Chatting Web Application', '2019-07-29', 2),
(25, '06-0218-2016', 'Dairy Hub', 'Dairy Milk Management System', '2019-07-29', 0),
(26, '06-0202-2016', 'PHMS', 'Plant Healthcare Management System', '2019-07-29', 2),
(27, '06-0202-2016', 'SPDS', 'Student Project Distribution System for CAIT', '2019-07-29', 2),
(34, '06-0218-2016', 'AgriNews', 'Agricultural news of india ...', '2019-08-02', 2),
(35, '06-0210-2016', 'Library Management system', 'System for library of AAU..', '2019-08-02', 0),
(36, '06-0210-2016', 'Online Vegetable Market', 'Like tomato, potato vegetable selling system.', '2019-08-02', 2),
(39, '06-0202-2016', 'MitraKitak', 'To give a exact information about Pest and also give prevention of Pest.', '2019-08-03', 0);
...
--
ALTER TABLE `major_guide`
  MODIFY `maj_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `title`
  MODIFY `t_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
